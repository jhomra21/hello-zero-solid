...
function App() {
  ...
  // View toggle state - default to the collaborative input
  const [viewMode, setViewMode] = createSignal<ViewMode>("collab");
  ...
  return (
    <Show when={initialSyncComplete()}>
      ...
      <div class="controls">
        <div class="tab-buttons">
          <button
            ...
            classList={{ active: viewMode() === "collab" }}
          >
            Collaborative
          </button>
          <button
            onClick={() => setViewMode("messages")}
            classList={{ active: viewMode() === "messages" }}
          >
            Messages
          </button>
          <button
            onClick={() => setViewMode("dev")}
            classList={{ active: viewMode() === "dev" }}
            class="dev-tab"
          >
            Dev
          </button>
      ...
      <Show when={viewMode() === "dev"}>
        <CollaborativeEditor documentId={COLLAB_DOC_ID} />
      </Show>
